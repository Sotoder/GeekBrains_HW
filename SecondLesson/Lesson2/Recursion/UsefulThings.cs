	...
	public class UsefulThings
	{
        public int CheckAndSetParamInt(string strFromConsole)
        {
            ...
            while (!flag)
            {
                ...
                {
                    Console.Write("Пожалуйста, вводите только целые числа, число должно быть не меньше - 2 147 483 647 и не больше 2 147 483 647.\nПовторите ввод:");
        ...
        public long CheckAndSetParamLong(string strFromConsole)
        {
            ...
            while (!flag)
            {
                ...
                {
                    Console.Write("Пожалуйста, вводите только целые числа, десятичные числа будут округлены.\n Повторите ввод:");
                    strFromConsole = Console.ReadLine();
                }
            }
            return param;
